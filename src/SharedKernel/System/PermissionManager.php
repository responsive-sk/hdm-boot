...
final class PermissionManager
{
    ...
    public const DIR_PERMISSION_STRICT = 0755;   // rwxr-xr-x
    public const FILE_PERMISSION_STRICT = 0644;  // rw-r--r--
    
    // Relaxed permissions (shared hosting)
    public const DIR_PERMISSION_RELAXED = 0777;  // rwxrwxrwx
    public const FILE_PERMISSION_RELAXED = 0666; // rw-rw-rw-
    
    // Log file permissions (need write access)
    public const LOG_FILE_PERMISSION = 0666;     // rw-rw-rw-
    
    // Cache permissions
    public const CACHE_DIR_PERMISSION = 0755;    // rwxr-xr-x
    public const CACHE_FILE_PERMISSION = 0644;   // rw-r--r--
    ...
    public function createDirectory(string $path, ?int $permissions = null): bool
    {
        ...
        $permissions = $permissions ?? $this->getDefaultDirectoryPermissions();
    ...
    public function createFile(string $path, string $content = '', ?int $permissions = null): bool
    {
        ...
        $permissions = $permissions ?? $this->getDefaultFilePermissions();
