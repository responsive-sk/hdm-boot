...
return [
    ...
    'services' => [
        ...
        SessionInterface::class => function (): SessionInterface {
            ...
            $sessionConfig = [
                ...
                'cookie_secure'   => ($_ENV['SESSION_COOKIE_SECURE'] ?? 'auto') === 'true' || (($_ENV['SESSION_COOKIE_SECURE'] ?? 'auto') === 'auto' && isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off'),
    ...
    'settings' => [
        'session' => [
            ...
            'cookie_secure'   => isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off', // Auto-detect HTTPS
