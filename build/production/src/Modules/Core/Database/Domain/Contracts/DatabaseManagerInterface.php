 ...
 *
 * Abstraction for database implementations using PDO.
...
interface FullDatabaseManagerInterface extends
    ...
    MigrationInterface
{
    // This interface combines all features for advanced database managers
    // Currently not implemented - PDO-based managers use simpler interfaces
}
