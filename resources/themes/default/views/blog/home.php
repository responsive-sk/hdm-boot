...
<head>
    <?= $theme::renderHead(
        'HDM Boot Blog',
        null,
        'Explore HDM Boot blog with articles about modern PHP development, hexagonal architecture, web frameworks, and best practices. Learn from real-world examples and tutorials.'
    ) ?>
</head>
